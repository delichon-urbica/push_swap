...
t_bool	rrr(char *str1, char *str2)
{
...
void	print_pairs(char *str1, char *str2)
{
	if (ss(str1, str2))
		ft_printf("ss\n");
	else if (rr(str1, str2))
		ft_printf("rr\n");
	else if (rrr(str1, str2))
		ft_printf("rrr\n");
}
...
void	print_cmd(char *str)
{
	...
	else if (ss(cmd, str) || rr(cmd, str) || rr(cmd, str))
	{
		print_pairs(cmd, str);
		free(cmd);
		cmd = NULL;
